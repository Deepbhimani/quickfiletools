...
const TOOL_CONFIG = {
  "image-compressor":     { name: "Image Compressor",     accept: { "image/*": [".jpg",".jpeg",".png",".webp"] }, maxFiles: 10, desc: "Compress images without losing quality.",      premium: false },
  "jpg-to-png":           { name: "JPG to PNG",           accept: { "image/jpeg": [".jpg",".jpeg"] },             maxFiles: 10, desc: "Convert JPG files to PNG format.",             premium: false },
  "png-to-jpg":           { name: "PNG to JPG",           accept: { "image/png": [".png"] },                      maxFiles: 10, desc: "Convert PNG files to JPG format.",             premium: false },
  "image-to-webp":        { name: "Image to WebP",        accept: { "image/*": [".jpg",".jpeg",".png"] },         maxFiles: 10, desc: "Convert images to modern WebP format.",        premium: false },
  "image-resizer":        { name: "Image Resizer",        accept: { "image/*": [".jpg",".jpeg",".png",".webp"] }, maxFiles: 10, desc: "Resize images to any custom dimension.",       premium: false },
  "image-to-pdf":         { name: "Image to PDF",         accept: { "image/*": [".jpg",".jpeg",".png",".webp"] }, maxFiles: 20, desc: "Convert multiple images into one PDF.",        premium: false },
  "pdf-merge":            { name: "PDF Merge",            accept: { "application/pdf": [".pdf"] },                maxFiles: 20, desc: "Merge multiple PDFs into one file.",            premium: false },
  "pdf-split":            { name: "PDF Split",            accept: { "application/pdf": [".pdf"] },                maxFiles: 1,  desc: "Extract specific pages from a PDF.",           premium: false },
  // ── PRO VERSION: set premium: true to re-enable gates ───────────────────
  "background-remover":   { name: "Background Remover",   accept: { "image/*": [".jpg",".jpeg",".png",".webp"] }, maxFiles: 1,  desc: "Remove image background instantly with AI.",   premium: false },
  "watermark-remover":    { name: "Watermark Remover",    accept: { "image/*": [".jpg",".jpeg",".png"] },         maxFiles: 1,  desc: "Remove watermarks from images.",               premium: false },
  "pdf-compress":         { name: "PDF Compress",         accept: { "application/pdf": [".pdf"] },                maxFiles: 5,  desc: "Reduce PDF file size significantly.",           premium: false },
  "pdf-to-word":          { name: "PDF to Word",          accept: { "application/pdf": [".pdf"] },                maxFiles: 5,  desc: "Convert PDF to editable Word document.",        premium: false },
  "pdf-ocr":              { name: "PDF OCR",              accept: { "application/pdf": [".pdf"] },                maxFiles: 5,  desc: "Extract text from scanned PDFs.",               premium: false },
  "esign-pdf":            { name: "E-Sign PDF",           accept: { "application/pdf": [".pdf"] },                maxFiles: 1,  desc: "Add your digital signature to any PDF.",        premium: false },
  "pdf-password-remover": { name: "PDF Password Remover", accept: { "application/pdf": [".pdf"] },                maxFiles: 5,  desc: "Remove password protection from PDFs.",         premium: false },
  // ─────────────────────────────────────────────────────────────────────────
};
...
export default function SingleTool() {
  ...
  // ── PRO VERSION: const { isPremium } = useAuth(); ─────────────────────────
  ...
  // ── PRO VERSION: re-enable this block ────────────────────────────────────
  // if (config.premium && !isPremium) return <ProGate name={config.name} />;
  // ─────────────────────────────────────────────────────────────────────────
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://quickfiletools.com/tools/${slug}`} />
      </Helmet>
